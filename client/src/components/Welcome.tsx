...
const Input = ({
  ...
  <input
    ...
    step="0.0001"
    value={value}
    onChange={(e) => handleChange(e, name as string)}
    className="my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white boder-none text-sm white-glassmorpism"
  />
);
